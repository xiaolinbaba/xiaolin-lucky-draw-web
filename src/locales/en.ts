export default {
  ...
  admin: {
    ...
    section: {
      ...
      visualSettings: 'Visual Style',
      patternSettings: 'Pattern and Display',
      list: 'Content List',
    },
    description: {
      viewSetting: 'Adjust the draw theme, dimensions, colors, and display behavior.',
      personList: 'Import, maintain, and export the participant list for this event.',
      winnerList: 'Review winners or return participants to the available pool.',
      prizeConfiguration: 'Configure prize order, quantities, images, and draw batches.',
  ...
  error: {
    ...
    importInvalid: 'Import failed. Check the file format, required columns, and duplicate participant numbers.',
    fileTooLarge: 'The file must not exceed {size} MB',
    notImage: 'Not Image',
    notAudio: 'Not an audio file',
    readmeLoadFailed: 'Unable to load the instructions. Please try again later.',
